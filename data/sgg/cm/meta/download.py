...
# Verrou pour les opérations sur les fichiers
file_lock = threading.Lock()
downloading = set()  # Fichiers en cours de téléchargement
...
def download_one(doc):
    ...
    # Vérifier si le fichier final existe et est complet
    with file_lock:
        ...
        # Vérifier si un autre thread télécharge déjà ce fichier
        if filename in downloading:
            msg = f"SKIP - {filename} ({taille}) - déjà en cours de téléchargement"
            return ('skip', msg)
